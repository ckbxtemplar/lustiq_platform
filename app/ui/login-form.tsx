...
export default function LoginForm() {
  ...
  return (
    ...
    //     <h1 className={`${barlow.className} mb-3 text-2xl`}>
...
<div className="register_form signup_login_form">
	...
	<Button className="btn btn_dark mb-5" aria-disabled={isPending}>
		<span>
	...
	>
		{errorMessage && (
			<div className="alert alert-warning d-flex align-items-center gap-1" role="alert">
	...
	<p className="mb-0 text-center">don't have an account? <a href="/regist">Register Here</a></p>
</div>
</form>
